...
export class ProductRepository {
  ...
  async FindAllWithPagination(limit: number, offset: number, searchName?: string, searchSku?: string, storeCode?: string, status?: string | string[]): Promise<{ products: Product[]; total: number }> {
    const logger = GetLogger();
